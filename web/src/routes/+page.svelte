...
<div class="home-page">
  <header class="header">
    <div class="header-content">
      ...
      <p class="description">
        Interactive exploration of Arch Linux configuration with annotated explanations
      </p>
    </div>
  ...
  <main class="main">
    ...
    <div class="content">
      <div class="welcome-card">
        ...
        <p>
          This interactive site showcases my Arch Linux configuration files. Browse the file
          tree on the left to explore different configs.
        </p>
              ...
              {#each data.repoData.annotatedFiles.slice(0, 6) as file}
                ...
                >
                  ...
                  <div class="file-card-info">
                    ...
                    <div class="file-card-annotations">{file.annotations.length} annotations</div>
                  </div>
                </a>
              {/each}
            </div>
          ...
          <div class="category-grid">
            {#each data.repoData.categories as category}
              ...
              >
                ...
                <div class="category-card-count">{category.files.length} files</div>
